...
all indicators of the Hornet see link:hornetinidicators.json[hornetinidicators.json].
...
link:hornetinidicators.json[hornetinidicators.json] for example of the
